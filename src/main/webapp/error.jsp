...
<p style="color: red;"><%= request.getParameter("message") %>
</p>
<% } %>
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div class="flex flex-col items-center">
            <!-- logo - start -->
            <a href="/" class="mb-8 inline-flex items-center gap-2.5 text-2xl font-bold text-indigo-500 md:text-3xl"
            ...
            <p class="mb-12 max-w-screen-md text-center text-gray-500 md:text-lg">Vì một số lý do nên bạn không thể truy
                cập tiếp.</p>
