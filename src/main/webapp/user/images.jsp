        ...
        <div class="mt-6 max-w-full">
          ...
          <section class="flex flex-col gap-4 rounded-xl bg-white p-5">
            <div class="flex items-center justify-between">
              <div>
                <h2 class="text-xl font-bold text-indigo-500 md:text-2xl">Quản lý hình ảnh</h2>
            ...
            <c:if test="${empty images}">
              <p>Chưa có ảnh nào <a href="<c:url value="/user/images?action=create"/>">thêm ngay.</a></p>
            </c:if>
                      ...
                      <div class="absolute inset-0 hidden px-4 py-3 group-hover:block">
                        <div class="flex justify-between">
                          <div class="flex flex-col text-white">
                            <a href="<c:url value="/view/image?id=${image.id}"/>"><p class="text-sm font-bold">${image.title}</p></a>
